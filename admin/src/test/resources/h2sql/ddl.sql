...
-- 添加deleted索引(普通索引)
ALTER TABLE `u_biz_merchant`
    ADD INDEX index1_deleted (`deleted`);
...
-- 添加deleted索引(普通索引)
ALTER TABLE u_permission
    ADD INDEX index2_deleted (`deleted`);
...
-- 添加deleted索引(普通索引)
ALTER TABLE u_role
    ADD INDEX index3_deleted (`deleted`);
...
-- 添加deleted索引(普通索引)
ALTER TABLE u_role_permission
    ADD INDEX index4_deleted (`deleted`);
...
-- 添加deleted索引(普通索引)
ALTER TABLE `u_biz_user`
    ADD INDEX index5_deleted (`deleted`);
ALTER TABLE `u_biz_user`
    ADD INDEX index5_username (`username`);
...
ALTER TABLE u_user_permission
    ADD INDEX index6_deleted (`deleted`);
...
ALTER TABLE u_user_role
    ADD INDEX index7_deleted (`deleted`);
