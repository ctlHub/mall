...
public class GmsGoodsEshopController {
    ...
    @PostMapping("/listByGoodsCode")
    public CommonResult<List<GmsGoodsAndEshop>> listByGoodsCode(@RequestBody GmsGoodsAndEshop goodsEshop) {
        List<GmsGoodsAndEshop> goodsAndEshopList = goodsEshopService.listByGoodsCode(goodsEshop);
