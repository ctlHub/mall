...
public class GmsGoodsService {
    ...
    public int updateGoodsSellStatus(GoodsLowerShelfUpdateParam dto) {
        ...
        return goodsDao.updateGoodsSellStatus(dto.getMerchantId(), dto.getLowerShelf(), dto.getCodes());
    }
    ...
    public List<GmsGoods> listGoods(GmsGoodsSearchParam goodsSearchParam) {
        ...
        List<GmsGoods> gmsGoods = (List<GmsGoods>) goodsDao.selectBySearchText(ThreadLocalUtil.getMerchant(), goodsSearchParam);
        return gmsGoods;
    }
    ...
    public int updateVirtualStock(List<GmsGoods> goodsList) {
        return goodsDao.updateVirtualStock(ThreadLocalUtil.getMerchant(), goodsList);
    }
}
